...
public class LineItems{
    ...
    public LineItems(){
        ...
        this.PumpNum = Console.ReadLine();
        Console.WriteLine("Введите номер позиции");
        this.LineNumber = Console.ReadLine();
        ...
        this.NetPrice = Console.ReadLine();        
        Console.WriteLine("Введите количество");
        this.QuantityRequested = Console.ReadLine();
